...
//        SecretKey secretKey = keyFactory.generateSecret(dks);   
	...
	public static void main(String[] args) {
		try{
			String inputStr = "DEsdfasasdfasdfLKJKLJOIJHOIHNKHNUIKJ+sdfdfasdfS";   
	        String key = initKey("asdfasdfasdf");   
	        ...
	        byte[] str = decryptBASE64(ss);
	        byte[] outputData = decrypt(str, key);   
