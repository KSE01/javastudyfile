...
<html>
	<head>
		...
		<script language="JavaScript" type="text/javascript" src="pages/images/global.js"></script>
	</head>
	<body>
					...
					<tr valign="top">
						<td width="99%">
							<p class="jive-breadcrumbs">
								<a href="">首页</a> &#187;
								<a href="">ChinaJavaWorld技术论坛|Java世界_中文论坛</a>&#187;
								<a href="">Java2 Platform, Standard Edition (J2SE)</a> &#187;
								<a href="">Java语言*初级版</a>
							</p>
								...
								<div class="jive-message-list">
									<div class="jive-table">
										<div class="jive-messagebox">
											<form action="addSubject.action" method="post">标题：
												<input type="text" name="subject"><br>内容：
												<textarea name="body" rows="15" cols="80"></textarea><br>
